...
let nota1 = prompt("digite 3 notas de x aluno: ")
nota1 = parseInt(nota1)

let nota2 = prompt("digite 3 notas de x aluno: ")
nota2 = parseInt(nota2)

let nota3 = prompt("digite 3 notas de x aluno: ")
...
let venda = qnt_estoque * preco

 console.log("Será vendido " +nome_produto+ ", e você faturará " +venda)
